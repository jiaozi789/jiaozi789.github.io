...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/10a6ebd8db76d0c0189348bc227beb29.png)
...
欠拟合与过拟合可用下图来形象地说明：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d0706f8b46588aeba72998fd0393b28e.png)
在改变模型的复杂度和训练集大小时，训练集和测试集的误差的函数图（改变模型复杂度时的误差）：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/59177837b40ee7e3fe22c703b48b272b.png)
改变数据集时的误差
![](https://i-blog.csdnimg.cn/blog_migrate/457b5bce8c0e1c23284ba6fe98e8f868.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/727b2e417b1c2d3c655dc143f960fd02.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d62a9a8fa40ce1d0b8bb51061a118c19.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/accdb916deb0c832c5ed454f3b1725c8.png)
...
## 正则化（regularization）
### 原理
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/532330039ecfd20633684abde9c0dc3b.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b0af813c916aa7bb5ae4374b3354f2ee.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7f6683cfb20c3346a2b99269fa07e8f0.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/91d826f9c25a7aa384014cfe0ac1942b.png)
封装一个函数生成测试集并测试模型
```
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/89b5ced9e99d8de133d795ff886fd68c.png)
调整 $\alpha$=1
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8eb6356ccce9b4ddf4c2d0f365a09dcd.png)
调整 $\alpha$=100
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/42aa145596f50a038945d926bb5a4983.png)
调整 $\alpha$=1000000
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a9677b330d443d757671a144059de210.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/78f056dc61111e55d73d7cdb4440fa9d.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ad1b0156098edc72fa8238b7e4e4d679.png)
调整 $\alpha$=1
```
TestRegression(20,1)
```
输出：1.8408939659515595
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b9b041c4409de70298a958d158ba08be.png)
### 解释Ridge和LASSO
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2ac51cddf22415a3b83f00d99cded206.png)
