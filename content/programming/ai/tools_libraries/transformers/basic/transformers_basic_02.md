...
# 什么是位置编码
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/ebd227ba994d4fa4751a41bd2af8836f.png)
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/fa4ea03032578205ebad4f9d1b1ae8eb.png)
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/6274ec65de29961f1c8e88d503e8637b.png)
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/0ab17fd041832a20d818081125e6cc96.png)
## 用[0,1]范围标记位置
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/49f0cbb686d251db319c58dc6069989a.png)
## 用二进制向量标记位置
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/6fb96ba20ffe7ae5f1cee1f5b2d11f56.png)
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/090f9247df7077cdfbd4bc1db3cb381b.png)
## 用周期函数（sin）来表示位置
### sin函数
先回顾下sin函数的几个概念，因为下面要用到sin函数：
#### 周期
周期是从一个最高点到下一个最高点（或任何一点到下一个相对点）：
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/d6e9616b1e83b76ea6b042c961cf12c3.png)
#### 振幅，相移，垂直位移
振幅是从中（平）线到最高点的高度（或到最低点），也是从最高点到最低点的距离除以2。
相移是函数比通常的位置水平向右移了多远。
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/519f2ecac767213e59aa6f1bae182ab9.png)
垂直位移是函数比通常的位置垂直向上移了多远。
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/8220a475a9eb3794d8774b568fa21933.png)
我们可以全部放进一个方程里：
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/bea4bd7e38a6c14525514c595b9ffa50.png)
#### 频率
频率是在一个时间单位里发生多少次（每 "1"）。
例子：这个正弦函数在0到1之间重复了4次：
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/f78f131e9df579671a9c328bd89327e8.png)
所以频率是 4
周期是  $\frac{1}{4}$
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/03b3c6d8b3da34b27336e2947dcc64a0.png)
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/e326e8e53ffe6833863b97637cae658d.png)
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/5ce2f86542acc91236080c24c4dc239b.png)
...
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/7ed8d7a18603e984fa44a25093751c27.png)
如上图假设：
...
```
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/d852b470a070116813c0914b297c5bb2.png)

## Transformer位置编码可视化
下图是一串序列长度为100，位置编码维度为512的位置编码可视化结果：
![在这里插入图片描述](/docs/images/content/programming/ai/tools_libraries/transformers/basic/transformers_basic_02.md.images/cd8528c83bc8928446c9e4f065ba5144.png)
