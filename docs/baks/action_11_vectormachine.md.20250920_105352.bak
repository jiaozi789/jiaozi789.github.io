...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2b3b235eafcecad963beba894d552e91.png)
于是大侠这样放，干的不错？
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d6154cb4930abd518532988f9ab1b728.png)
然后魔鬼，又在桌上放了更多的球，似乎有一个球站错了阵营。显然，大侠需要对棍做出调整。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/270724ba42ce8f7f00ebcfc045909b8e.png)
SVM就是试图把棍放在最佳位置，好让在棍的两边有尽可能大的间隙。这个间隙就是球到棍的距离。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f49b55ae0b5e81c6331062b0f0d216b6.png)
现在好了，即使魔鬼放了更多的球，棍仍然是一个好的分界线。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/906a3394bafd469c688d427b8767ee8b.png)
现在，大侠没有棍可以很好帮他分开两种球了，现在怎么办呢？当然像所有武侠片中一样大侠桌子一拍，球飞到空中。然后，凭借大侠的轻功，大侠抓起一张纸，插到了两种球的中间。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e4ca982b6cfaec51c6d330e28b4e71ec.png)
现在，从空中的魔鬼的角度看这些球，这些球看起来像是被一条曲线分开了。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/3739ab43baa062b9680294cd6946f9a5.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/16e6ebdeec1748c819ce2da52683c3d8.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1a9bbe733daef46207ce9a0a9a3c3b8f.png)
...
对每个样本点xi加上一个类别标签yi：
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cca117f7d3dfb624c2601f7faee5978f.png)

![技巧](https://i-blog.csdnimg.cn/blog_migrate/dcdb62dd4b1b1d583aa4d197dab71eb2.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d11e0a244926976c2e46ad9ec623d89c.png)
还有一种更一般的例子，那就是如果有一个蓝色的点混进了红色的点当中，这就导致数据集根本就是线性不可分的情况，根本找不出一条直线能够将这两类分开，在这种情况下Hard margin就不再是泛化能力强不强的问题，而是根本找不出一条直线将其分开。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6d8d193c2524b04627125645b92714ce.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/47e2510b0f2caad67bd7ba6f4ff37d8b.png)
L1正则
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5e2e710054afd32198a6236efe9cb615.png)
实现svm，先使用一个比较大的C。
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6a7b36e962f4771543a9f078a7ee2d34.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/565b39aa55ae400899acb2bfac2fb40e.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/57a17a4ebd47a6d6514c34845bd13546.png)
接下来给数据添加一些随机噪声：
```
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/15eac053aa4ccbc7e74a583d72ca9c67.png)
使用多项式，归一，线性svm
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/552d6d5fd24ee0ebb1d4fa845a83e0fc.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5d3736357e2b6399e96eeb5f24c7bec4.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b6e08363e7e6fdb86d486d609fd45bea.png)
转换为以下函数后，数据变的线性可分。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/6fc4aab315161fc40c6e88008013baf3.png)
常用 核函数：
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d222c6c879611dd29ff99c0938bc7f36.png)
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7421874594815aee0929019f21b85f85.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1b5686771022e7bb9afcb64695dfb076.png)
高斯核后
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/158046a766c34d4a1668727508941e92.png)
其实，真正的高斯核函数实现的过程中并不是固定的$\gamma$，而是对于每一个数据点都是$\gamma$，这里写死 gamma = 1.0。
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2f7e98f5be0b735f23fb540a31e86e3f.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1ca48dc7be58d12381e25fc0872b7a9d.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/71bef1a76bffc70e17421576f9de4296.png)
...
plt.show()
```
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5d591823ac1e33512868a520cca4c045.png)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ae31eaf34f8933b8606442f0e5be068b.png)
